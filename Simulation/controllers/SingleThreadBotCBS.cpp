...
std::vector<Point> SingleThreadBotCBS::findOptimalPath(){
        return sMap.findPath(lastLocation, stationPlan.front());
}

void SingleThreadBotCBS::sortJob(const std::vector<std::vector<float>> &shortestDistances, std::vector<int> &job) {
